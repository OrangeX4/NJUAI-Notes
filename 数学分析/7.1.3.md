...
$\displaystyle \sum_{n=1}^{\infty} \left|\frac{\cos nx}{n}\right|\geqslant \sum_{n=1}^{\infty}\frac{\cos^{2}n}{n}=\sum_{n=1}^{\infty}\frac{1+\cos_2n}{2n}=\sum_{n=1}^{\infty}\frac{1}{2n}+\sum_{n=1}^{\infty}\frac{\cos 2n}{2n}$
