...
$\therefore\displaystyle\int\cos^4x{\rm d}x=\frac{1}{4}\sin x\cos^3+\frac{3}{8}x+\frac{3}{16}\sin2x$
...
$令x+1=\sqrt{t-2}, t\geq 2$

$$
\begin{aligned}
\int\frac{{\rm d}x}{(x+1)\sqrt{x^2+2x+3}}&=\int\frac{{\rm d}(x+1)}{(x+1)\sqrt{(x+1)^2+2}} \\
\end{aligned}
$$
...
$令x=\displaystyle\frac{2}{t^2+1}-1, t\geq 0$

$$
\begin{aligned}
\int x\sqrt{\frac{1-x}{1+x}}{\rm d}x&=\int x\sqrt{\frac{2}{1+x}-1}{\rm d}x \\
&=\int (\frac{2t}{t^2+1}-t){\rm d}\frac{2}{t^2+1} \\
&=4\int \frac{t^4-t^2}{(t^2+1)^3}{\rm d}t \\
\end{aligned}
$$

$$
\begin{aligned}
\frac{At+B}{t^2+1}+\frac{Ct+D}{(t^2+1)^2}+\frac{Et+F}{(t^2+1)^3} \\
\end{aligned}
$$
