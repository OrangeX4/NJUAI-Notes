...
&=\lim_{\Delta x\to 0}\left[1+\frac{A\cdot \Delta x}{f(a)}\right]^{\frac{A}{f(a)\cdot \Delta x}\cdot\frac{f(a)}{A}} \\
&=e^{\frac{f(a)}{f'(a)}}
\end{aligned}
$
...
$\therefore \displaystyle\lim_{\Delta x\to 0}f(a+\Delta x)=f(a)$

$\therefore \displaystyle\lim_{n\to \infty}\left[\frac{f(a+\frac{1}{n})}{f(a)}\right]^n=1$
