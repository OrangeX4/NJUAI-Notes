...
$\displaystyle令s=2t, t=\frac{\pi}{2}-u$
...
$判断\displaystyle\int_0^\infty\frac{\ln x}{1+x^2}{\rm d}x是否收敛$
...
$对于\displaystyle\int_1^\infty x^a\sin\frac{1}{x}{\rm d}x来说, g(x)=\sin\frac{1}{x}在[1,+\infty)单调递减且趋向于0$
