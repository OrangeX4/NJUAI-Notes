...
$\therefore A^{-1}=\begin{pmatrix}B&B\\B&-B\end{pmatrix}^{-1}=\begin{pmatrix}2B&O\\0&-B\end{pmatrix}^{-1}\begin{pmatrix}E&O\\-\frac{1}{2}E&E\end{pmatrix}\begin{pmatrix}E&E\\O&E\end{pmatrix}$